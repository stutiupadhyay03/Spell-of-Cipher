...
if(empty($nameErr) && empty($universityErr) && empty($gendererr)){
    ...
    if(empty($data))
    {
        ...
        $sql = "INSERT into profile_info values ('".$_POST['userlogo']."','".$_POST['name']."','".$_POST['contact']."','".$_POST['univ']."','".$_POST['yos']."','".$_POST['gender']."','".$_POST['Age']."','".$_POST['user_email']."','".$_POST['leaderboard_name']."','".$_POST['title']."','".$_POST['stream']."','NA','NA')";
