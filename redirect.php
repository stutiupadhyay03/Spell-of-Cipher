...
if($send=="true"){
    ...
    $mail->Body = "<h4>Greetings Spell Caster,</h4>
      ...
      <a href='http://spellofcipher.in/paymentrequest.php?participant=".$email."&rank=".$newid."'>Click Here</a>  to activate your account and complete the payment procedure. Hope you have hassle-free experience and an even better coding experience in this competition.<br><br>
      For any queries,
      <br><br>
...
<HTML>
<HEAD>
<TITLE>Aggrepay - Business Payment Return Page</TITLE>
