    ...
    <div class="container-fluid" class="overflow=scroll">
        ...
        <center>
            ...
            <h2> Your Registration was Successful! </h2>
             <!-- A Verification Email is sent on <span style='color:#262262;'> <i>'".$email."'</i></span> -->
...
$mail=$_SESSION['user_email'];
 ...
 while($detail=mysqli_fetch_array($query1)){
  $rank=$detail['paisa'];
 }
...
if(isset($_POST['resend'])){
    ...
    $mail->Body = "<h4>Greetings Spell Caster,</h4>
      ...
      <a href='http://192.168.137.1/soc/paymentrequest.php?participant=".$email."&rank=".$rank."'>Click Here</a>  to activate your account and complete the payment procedure. Hope you have hassle-free experience and an even better coding experience in this competition.<br><br>
      For any queries,
      <br><br>
